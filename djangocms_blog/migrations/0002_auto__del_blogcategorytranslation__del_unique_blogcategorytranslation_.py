...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.author'
        db.alter_column(u'djangocms_blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label]))
    ...
    models = {
        ...
        u'djangocms_blog.authorentriesplugin': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm[user_orm_label]", 'symmetrical': 'False'}),
        ...
        u'djangocms_blog.blogcategory_translation': {
        ...
        u'djangocms_blog.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm[user_orm_label]", 'null': 'True', 'blank': 'True'}),
        ...
        u'djangocms_blog.post_translation': {
        ...
        'filer.file': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_files'", 'null': 'True', 'to': u"orm[user_orm_label]"}),
        ...
        'filer.folder': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_owned_folders'", 'null': 'True', 'to': u"orm[user_orm_label]"}),
